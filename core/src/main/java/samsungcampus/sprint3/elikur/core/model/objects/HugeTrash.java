...
public class HugeTrash extends Trash {
    public HugeTrash(World world) {
        super(GameResources.TRASH2_IMG_PATH,
        ...
        body.setLinearVelocity(new Vector2(0, (int) -(GameSetting.TRASH_VELOCITY * 0.5) * GameScreen.getMultiplayerSpeed()));
